...
def test_train_config_selects_matching_features_skeleton_and_vae():
    ...
    assert int(v6.denoiser.goal_dim) == 67
    assert v6.data.goal_encoding == 'split_end_effector'
    ...
    assert int(planner.denoiser.goal_dim) == 67
    assert planner.data.goal_encoding == 'split_end_effector'
